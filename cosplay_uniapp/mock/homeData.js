...
export const homeData = [
  {
    id: '1',
    category: '影棚置景',
    topBg: 'https://oxy-1258558723.cos.ap-shanghai.myqcloud.com/oxy_mini/img/doro_bg.png',
    menu: [
      { id: 0, key: 'studioList', name: '影棚列表', page: '/studioList', img: getRandomImage() },
      { id: 1, key: 'activity', name: '活动情报', page: '/', img: getRandomImage() },
      { id: 2, key: 'memberCenter', name: '会员中心', page: '/', img: getRandomImage() },
      { id: 3, key: 'tips', name: '注意事项', page: '/', img: getRandomImage() }
    ],
    subClass: [
    ...
    recommend: [
      { id: 'rec001', tip: '咨询', title: '夏日限定主题影棚', price: 399, discount: 0.85, image: 'https://example.com/summer_studio.jpg' },
      { id: 'rec002', tip: '官方', title: '古风汉服专属影棚', price: 499, discount: 0.9, image: 'https://example.com/hanfu_studio.jpg' }
    ]
  },
  {
    id: '2',
    category: '户外外景',
    topBg: 'https://oxy-1258558723.cos.ap-shanghai.myqcloud.com/oxy_mini/img/cat_bg.png',
    menu: [
      { key: 'outdoorList', name: '外景地点', page: '/outdoorList', img: getRandomImage() },
    ...
    recommend: [
      { id: 'out001', tip: '推荐', title: '城市天际线夜景', price: 599, rating: 4.8, image: 'https://example.com/skyline.jpg' },
      { id: 'out002', tip: '推荐', title: '郊外花海全景', price: 450, rating: 4.6, image: 'https://example.com/flower_field.jpg' }
    ]
  },
  {
    id: '3',
    category: 'C服&道具&周边',
    topBg: 'https://oxy-1258558723.cos.ap-shanghai.myqcloud.com/oxy_mini/img/feibi_bg.png',
    menu: [
      { key: 'cosplayList', name: 'C服租赁', page: '/cosplayList', img: getRandomImage() },
      { key: 'props', name: '道具租赁', page: '/', img: getRandomImage() },
      { key: 'peripherals', name: '动漫周边', page: '/', img: getRandomImage() },
    ...
    recommend: [
      { id: 'cos001', tip: '推荐', title: '原神-雷电将军C服', price: 899, stock: 10, image: 'https://example.com/raiden_cos.jpg' },
      { id: 'cos002', tip: '联名', title: '鬼灭之刃-灶门炭治郎道具套装', price: 299, stock: 15, image: 'https://example.com/tanjiro_props.jpg' }
    ]
  },
  {
    id: '4',
    category: '拼好团',
    topBg: 'https://oxy-1258558723.cos.ap-shanghai.myqcloud.com/oxy_mini/img/xuehua_bg.png',
    menu: [{ key: 'activeGroups', name: '注意事项', page: '/activeGroups', img: getRandomImage() }],
    subClass: [
    ...
    recommend: [
      { id: 'group001', tip: '优惠', title: '三人同行影棚套餐', originalPrice: 1499, groupPrice: 999, participants: 2, totalNeeded: 3, endTime: '2025-08-30T23:59:59' },
      { id: 'group002', tip: '优惠', title: '双人C服租赁优惠', originalPrice: 1198, groupPrice: 899, participants: 1, totalNeeded: 2, endTime: '2025-08-25T23:59:59' }
    ]
  },
  {
    id: '5',
    category: '漫展快闪',
    topBg: 'https://oxy-1258558723.cos.ap-shanghai.myqcloud.com/oxy_mini/img/maoluo_bg.png',
    menu: [
      { key: 'upcomingEvents', name: '即将开始', page: '/upcomingEvents', img: getRandomImage() },
    ...
    recommend: [
      { id: 'event001', tip: '官方', title: '2025夏季动漫嘉年华', date: '2025-09-15至2025-09-17', location: '上海新国际博览中心', ticketsAvailable: true },
      { id: 'event002', tip: '官方', title: '二次元文化快闪店', date: '2025-08-20至2025-08-30', location: '北京朝阳大悦城', ticketsAvailable: true }
    ]
  },
  {
    id: '6',
    ...
    topBg: 'https://oxy-1258558723.cos.ap-shanghai.myqcloud.com/oxy_mini/img/feibi_bg.png',
    menu: [
      { key: 'latestNews', name: '最新资讯', page: '/latestNews', img: getRandomImage() },
    ...
    recommend: [
      { id: 'article001', tip: '推荐', title: '新手coser必看！10个拍摄技巧让你的照片更专业', author: '资深摄影师小王', views: 12540, comments: 328 },
      { id: 'article002', tip: '推荐', title: '2025年最值得期待的10部动漫新番', author: '动漫评论家小李', views: 8762, comments: 412 }
    ]
  }
]
