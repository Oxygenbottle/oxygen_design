    ...
    <view class="canvas-container">
      ...
      <view class="pagination">
        ...
        <view class="page-controls">
          <button size="mini" @click="prevPage" :disabled="currentPage <= 1">上一页</button>
          <button size="mini" @click="nextPage" v-if="currentPage < totalPages">下一页</button>
          <button
            v-else-if="!isSigned"
            size="mini"
          ...
          <button v-else size="mini" @click="openSignatureModal" class="resign-btn">
            重新签署
          </button>
          <button v-if="isSigned" size="mini" @click="confirmSignature" class="confirm-btn">
            确认
          </button>
        </view>
      </view>
